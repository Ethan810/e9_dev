exports.getPath = function (config) {
  ...
  "fnaSpecial":{
    ...
    //后台人力
    "ba_hrm": {
      entry: config.srcPath + "/src4js/pc4backstage/hrmengine/index.js",
      output: config.runPath + "/spa/hrm/engine.js",
      styleUrl: config.runPath + "/spa/hrm/engine.css",
      outputlib: {
    ...
    //人力
    "E9_hrm": {
      entry: config.srcPath + "/src4js/pc4mobx/hrm/index.js",
      output: config.runPath + "/spa/hrm/index_mobx.js",
      styleUrl: config.runPath + "/spa/hrm/index_mobx.css",
      outputlib: {
        library: "weaHrm",
        libraryTarget: "umd"
      },
    ...
    //集成_mobx
    "inte_mobx": {
      entry: config.srcPath + "/src4js/pc4mobx/inte/index.js",
      output: config.runPath + "/spa/inte/index_mobx.js",
      styleUrl: config.runPath + "/spa/inte/index_mobx.css",
      outputlib: {
        library: "weaInte",
        libraryTarget: "umd"
      }
    ...
    //集成_mobx单页
    "inte4single_mobx": {
      entry: config.srcPath + "/src4js/pc4mobx/inte/single.js",
      output: config.runPath + "/spa/inte/index4single_mobx.js",
      styleUrl: config.runPath + "/spa/inte/index4single_mobx.css",
    },
    //日程
    "workplan": {
   ...
   //微博-mobx版本
    ...
    "cpt4single_mobx": {
     ...
     "crm_mobx": {
      ...
      output: config.runPath + "/spa/crm/index_mobx.js",
      styleUrl: config.runPath + "/spa/crm/index_mobx.css",
      outputlib: {
        library: "weaCrm",
        libraryTarget: "umd"
      }
    ...
    "crm4single_mobx": {
      ...
      output: config.runPath + "/spa/crm/index4single_mobx.js"
    },
  }
